    ...
    <>
      ...
      <section id="pricing">
        <div className="section">
          <div className="section-label scroll-animate">Transparent Pricing</div>
          ...
          <div className="pricing-grid scroll-animate-group">
            {plans.map((plan, i) => (
      ...
      <section id="contact" style={{ background: C.surface, borderTop: `1px solid ${C.border}` }}>
        <div className="section">
          <div className="contact-grid scroll-animate-group">
            <div>
