    ...
    <>
      ...
      <section id="pricing">
        <div className="section">
          <div className="section-label" data-animate="true">Transparent Pricing</div>
          <h2 className="section-title" data-animate="true">
          ...
          <div className="pricing-grid" data-animate-group="true">
            {plans.map((plan, i) => (
      ...
      <section id="contact" style={{ background: C.surface, borderTop: `1px solid ${C.border}` }}>
        <div className="section">
          <div className="contact-grid" data-animate-group="true">
            <div>
