...
// Interactive pieces (nav scroll, mobile menu, contact form, pricing buttons)
// are isolated in app/components/HomeInteractive.tsx
    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Pricing (styles only — markup in HomeInteractive) ── */
        .pricing-grid {
          display: grid; grid-template-columns: repeat(3, 1fr);
          gap: 1px; background: ${C.border};
          border: 1px solid ${C.border}; margin-top: 64px;
      ...
      {/* HomeInteractive renders the nav (it needs scroll state) */}
      <HomeInteractive />

      {/* ── HERO (static — fully server rendered) ── */}
      <section id="hero" className="hero">
        ...
        {/* Hero buttons rendered by HomeInteractive above via
            the hero-actions-client div — inserted directly after nav */}
      </section>
      ...
      {/* Pricing + Contact rendered by HomeInteractive (need onClick handlers) */}
