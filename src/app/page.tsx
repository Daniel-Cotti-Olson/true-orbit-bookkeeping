    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .scroll-animate-group.is-visible > *:nth-child(1) { opacity: 1; transform: translateY(0); transition-delay: 0s; }
        .scroll-animate-group.is-visible > *:nth-child(2) { opacity: 1; transform: translateY(0); transition-delay: 0.1s; }
        .scroll-animate-group.is-visible > *:nth-child(3) { opacity: 1; transform: translateY(0); transition-delay: 0.2s; }
        .scroll-animate-group.is-visible > *:nth-child(4) { opacity: 1; transform: translateY(0); transition-delay: 0.3s; }
        .scroll-animate-group.is-visible > *:nth-child(5) { opacity: 1; transform: translateY(0); transition-delay: 0.4s; }
        .scroll-animate-group.is-visible > *:nth-child(6) { opacity: 1; transform: translateY(0); transition-delay: 0.5s; }
      ...
      {/* ── STAT STRIP ── */}
      <div className="stat-strip scroll-animate-group" aria-label="Key statistics">
        {stats.map((s, i) => (
      ...
      <section id="services" aria-labelledby="services-heading">
        <div className="section">
          <div className="section-label scroll-animate">Expert Financial Services</div>
          <h2 className="section-title scroll-animate" id="services-heading">
            Everything Your Business<br />
            <span>Needs to Thrive</span>
          </h2>
          <p className="section-body scroll-animate">
          ...
          <div className="bento-grid scroll-animate-group">
            {services.map((s, i) => (
      ...
      >
        <div className="section">
          <div className="about-grid scroll-animate-group">
            {/* Photo */}
      ...
      <footer className="footer">
        <div className="footer-inner scroll-animate-group">
          <div>
            <Image
