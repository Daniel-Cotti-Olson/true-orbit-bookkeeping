...
//   ScrollAnimator   — IntersectionObserver for scroll-triggered animations (no markup)
    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Hero elements animate on load via CSS */
        .fade-up { animation: fadeUp 0.7s ease both; }

        /* Scroll-triggered: hidden until IntersectionObserver adds .is-visible */
        [data-animate] {
          opacity: 0;
        ...
        [data-animate-group].is-visible > *:nth-child(1) { opacity: 1; transform: translateY(0); transition-delay: 0s; }
        [data-animate-group].is-visible > *:nth-child(2) { opacity: 1; transform: translateY(0); transition-delay: 0.1s; }
        [data-animate-group].is-visible > *:nth-child(3) { opacity: 1; transform: translateY(0); transition-delay: 0.2s; }
        [data-animate-group].is-visible > *:nth-child(4) { opacity: 1; transform: translateY(0); transition-delay: 0.3s; }
        [data-animate-group].is-visible > *:nth-child(5) { opacity: 1; transform: translateY(0); transition-delay: 0.4s; }
        [data-animate-group].is-visible > *:nth-child(6) { opacity: 1; transform: translateY(0); transition-delay: 0.5s; }
      ...
      <HomeInteractive />
      {/* Scroll animations: watches data-animate elements, adds .is-visible on entry */}
      <ScrollAnimator />
      ...
      {/* ── STAT STRIP ── */}
      <div className="stat-strip" aria-label="Key statistics" data-animate-group="true">
        {stats.map((s, i) => (
      ...
      <section id="services" aria-labelledby="services-heading">
        <div className="section">
          <div className="section-label" data-animate="true">Expert Financial Services</div>
          <h2 className="section-title" id="services-heading" data-animate="true">
            Everything Your Business<br />
            <span>Needs to Thrive</span>
          </h2>
          <p className="section-body" data-animate="true">
          ...
          <div className="bento-grid" data-animate-group="true">
            {services.map((s, i) => (
      ...
      >
        <div className="section">
          <div className="about-grid" data-animate-group="true">
            {/* Photo */}
      ...
      <footer className="footer">
        <div className="footer-inner" data-animate-group="true">
          <div>
            <Image
